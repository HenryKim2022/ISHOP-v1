...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/home/itir9421/public_html/ishop.iti-if.my.id/phpmyadmin/templates/database/structure/bulk_action_modal.twig");
    }
}
