...
class AdminsController extends Controller
{
    ...
    public function activate(Request $request)
    {
        try {
			...
			$fakelicense = '{"data":{"status":200,"token":"00000","message":"Verified by nullcave", "secret_key":"secret_key", "public_key":"public_key", "encrypt_key":"encrypt_key","encrypt_iv":"encrypt_iv", "valid":true}}';

			$body = json_decode($fakelicense);
